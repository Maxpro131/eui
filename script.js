document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        en: {
            ...
            view_changelog_button: "<i class='fas fa-clock-rotate-left'></i> View Full Changelog →",
            join_vip_button: "⭐ Join VIP",
            vip_link: "VIP",
            vip_exclusive: "p3s — VIP Exclusive",
            get_vip_access: "Get VIP Access",
            device_version_free: "Current free version: <strong>8.6.0</strong>",
            device_version_vip: "VIP version available: <strong>8.6.1</strong>",
        ...
        es: {
            ...
            view_changelog_button: "<i class='fas fa-clock-rotate-left'></i> Ver Lista de Cambios Completa →",
            join_vip_button: "⭐ Unirse al VIP",
            vip_link: "VIP",
            vip_exclusive: "p3s — Exclusivo VIP",
            get_vip_access: "Obtener Acceso VIP",
            device_version_free: "Versión gratuita actual: <strong>8.6.0</strong>",
            device_version_vip: "Versión VIP disponible: <strong>8.6.1</strong>",
            // --- VIP PAGE TRANSLATIONS ---
        ...
        hi: {
            ...
            view_changelog_button: "<i class='fas fa-clock-rotate-left'></i> पूरा चेंजलॉग देखें →",
            join_vip_button: "⭐ वीआईपी से जुड़ें",
            vip_link: "वीआईपी",
            vip_exclusive: "p3s — वीआईपी एक्सक्लूसिव",
            get_vip_access: "वीआईपी एक्सेस प्राप्त करें",
            device_version_free: "मौजूदा फ्री वर्शन: <strong>8.6.0</strong>",
            device_version_vip: "वीआईपी वर्शन उपलब्ध: <strong>8.6.1</strong>",
            // --- VIP PAGE TRANSLATIONS ---
        ...
        pt: {
            ...
            view_changelog_button: "<i class='fas fa-clock-rotate-left'></i> Ver Registro Completo →",
            join_vip_button: "⭐ Entrar no VIP",
            vip_link: "VIP",
            vip_exclusive: "p3s — Exclusivo VIP",
            get_vip_access: "Obter Acesso VIP",
            device_version_free: "Versão gratuita atual: <strong>8.6.0</strong>",
            device_version_vip: "Versão VIP disponível: <strong>8.6.1</strong>",
            // --- VIP PAGE TRANSLATIONS ---
